...
| 子模块 | 概述 | 科研 BOM |
|--------|------|----------|
| [扬声器-开放式定向发声/](./扬声器-开放式定向发声/) | OWS、LBS 漏音抑制 | [科研/](./扬声器-开放式定向发声/科研/) |
| [MEMS麦克风阵列/](./MEMS麦克风阵列/) | 3–4 颗、波束成形 | [科研/](./MEMS麦克风阵列/科研/) |

**子系统 BOM 汇总** → [科研-声学子系统BOM汇总.md](./科研-声学子系统BOM汇总.md)（中位 **~$3.9** / 副）
